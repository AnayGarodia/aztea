...
from aztea import AzteaClient, MessageType
...
def main() -> None:
    ...
    public = AzteaClient(base_url=base_url)
    ...
    worker = AzteaClient(base_url=base_url, api_key=str(worker_user["raw_api_key"]))
    caller = AzteaClient(base_url=base_url, api_key=str(caller_user["raw_api_key"]))
