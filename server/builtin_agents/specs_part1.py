    ...
    "output_schema": _output_schema_object(
        {
            ...
            "review_target": {"type": "string", "enum": ["code", "diff", "code_and_diff"]},
        ...
        required=["score", "summary", "issues", "issue_count", "severity_counts"],
    ),
    "output_examples": [
        {
            "input": {
            ...
            "output": {
                ...
                "test_recommendations": ["Add a test for b == 0 and assert the intended error or fallback behavior."],
        ...
        },
        {
            ...
            "output": {
                ...
                "positive_aspects": ["The authorization header is read in a single place, which makes remediation localized."],
                "test_recommendations": ["Add a logging test that asserts bearer tokens are never emitted, even in debug mode."],
