...
- **MCP tool count is CI-checked** (`tests/test_mcp_lazy_tool_surface.py`). Lazy mode currently advertises **7 tools** (down from 9 — `aztea_call_streaming` and `aztea_steer` were dropped 2026-05-17 for the broken streaming pipeline).
