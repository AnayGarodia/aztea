...
class GroqProvider:
    ...
    def complete(self, req: CompletionRequest) -> LLMResponse:
        ...
        except self._groq_mod.RateLimitError as exc:
            raise LLMRateLimitError("groq", req.model, str(exc), exc) from exc
        except self._groq_mod.APITimeoutError as exc:
