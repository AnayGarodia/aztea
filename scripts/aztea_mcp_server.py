...
_LAZY_DO_TOOL: dict[str, Any] = {
    ...
    "description": (
        ...
        "Gating thresholds (deployment-tunable via env vars; surfaced here so callers "
        "can predict when a call short-circuits to a no-charge candidate list):\n"
        "  - confidence floor: 0.30 (or 0.20 with `aggressive=true`) — "
